#ifndef HOTAOSA_DATASTRUCTURE_RANGE_ADD_RANGE_SUM_H_
#define HOTAOSA_DATASTRUCTURE_RANGE_ADD_RANGE_SUM_H_
...
#endif  // HOTAOSA_DATASTRUCTURE_RANGE_ADD_RANGE_SUM_H_
